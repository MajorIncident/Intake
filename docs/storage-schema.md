...
| `causes` | array | 2 |
| `decisionAnalysis` | object | 2 |
| `decisionAnalysis.decision` | string | 2 |
| `decisionAnalysis.delegatedOwner` | string | 2 |
| `decisionAnalysis.options` | string | 2 |
| `decisionAnalysis.ownerRole` | string | 2 |
| `decisionAnalysis.rationale` | string | 2 |
| `decisionAnalysis.selectedOption` | string | 2 |
| `decisionAnalysis.timestamp` | string | 2 |
| `handover` | object | 2 |
...
| `potentialProblemAnalysis` | object | 2 |
| `potentialProblemAnalysis.changeControl` | object | 2 |
| `potentialProblemAnalysis.changeControl.required` | boolean | 2 |
| `potentialProblemAnalysis.owner` | object | 2 |
| `potentialProblemAnalysis.owner.category` | string | 2 |
| `potentialProblemAnalysis.owner.lastAssignedAt` | string | 2 |
| `potentialProblemAnalysis.owner.lastAssignedBy` | string | 2 |
| `potentialProblemAnalysis.owner.name` | string | 2 |
| `potentialProblemAnalysis.owner.notes` | string | 2 |
| `potentialProblemAnalysis.owner.source` | string | 2 |
| `potentialProblemAnalysis.owner.subOwner` | string | 2 |
| `potentialProblemAnalysis.risk` | object | 2 |
| `potentialProblemAnalysis.risk.ifHappens` | string | 2 |
| `potentialProblemAnalysis.risk.impactIfFails` | string | 2 |
| `potentialProblemAnalysis.risk.level` | string | 2 |
| `potentialProblemAnalysis.risk.prevent` | string | 2 |
| `potentialProblemAnalysis.verification` | object | 2 |
| `potentialProblemAnalysis.verification.required` | boolean | 2 |
| `pre` | object | 2 |
...
### Major Incident decision and potential-problem cards (`src/majorIncidentAnalysis.js`)

- **Anchor / DOM roots:** `<!-- [feature:major-incident-analysis] -->`, `#decisionAnalysisCard`, and `#potentialProblemAnalysisCard` after Possible Causes.
- **Fields:** `decisionAnalysis.{decision,options,selectedOption,ownerRole,delegatedOwner,rationale,timestamp}` and `potentialProblemAnalysis.{owner,risk,changeControl,verification}`.
- **Notes:** Potential Problem Analysis uses the same owner, `{ level, impactIfFails, prevent, ifHappens }` risk, `changeControl.rollbackPlan`, and `verification.result` shapes as action records. This keeps change-risk data portable rather than introducing a parallel schema.
