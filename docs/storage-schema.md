...
| `causes` | array | 1 |
| `handover` | object | 1 |
| `handover.current-state` | string | 1 |
| `handover.must-watch-metrics` | string | 1 |
| `handover.remaining-risks` | string | 1 |
| `handover.what-changed` | string | 1 |
| `handover.whats-next` | string | 1 |
| `impact` | object | 1 |
