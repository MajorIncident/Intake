...
export async function generateSummary(kind = 'summary', aiType = '', stateInput){
  ...
  if(normalizedType === 'ai summary'){
    const expertPrefix = `Here’s how I’d tune your prompt to better reflect Module 6 “Comms that Calm” — especially the **messaging map (What / So What / Now What)** and **timing & cadence** focus.
