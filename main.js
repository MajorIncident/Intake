...
/**
 * ROWS enumerates the KT IS / IS NOT prompts in display order.
 * Updating questions requires revisiting table rendering, persistence, and summaries.
 */
const ROWS = [
...
/**
 * STEP_DEFINITIONS enumerates the incident-playbook checklist shown in the
 * drawer. Treat as protected data: update persistence, summaries, and docs if
 * items change.
 */
